export const Laboratorio = {
  template: `
  <div id="app">
    <!-- Imagem que ao ser clicada abre o modal -->
    <img
    ...
    <div v-if="isModalOpen" class="modal-overlay">
      <div class="modal-card">
        ...
        <input type="text" v-model="inputValue" placeholder="Digite algo...">
        <button @click="submitInput">Enviar</button>
      </div>
    </div>
  </div>
`,
...
methods: {
  ...
  // Função para enviar o valor do input
  submitInput() {
    alert(`Você digitou: ${this.inputValue}`);
