...
CREATE TABLE `laboratorio_equipamento` (
  `id_laboratorio_equipamento` int DEFAULT NULL,
  `id_equipamento` int DEFAULT NULL,
  `id_software` int DEFAULT NULL,
  KEY `id_equipamento` (`id_equipamento`),
  KEY `id_software` (`id_software`),
  CONSTRAINT `laboratorio_equipamento_ibfk_1` FOREIGN KEY (`id_equipamento`) REFERENCES `equipamento` (`id_equipamento`),
  CONSTRAINT `laboratorio_equipamento_ibfk_2` FOREIGN KEY (`id_software`) REFERENCES `software` (`id_software`)
...
INSERT INTO `laboratorio_equipamento` VALUES (6,14,NULL);
